...
the instructions in references/summary_prompt.md.

Usage:
  python3 scripts/analyze_comments.py                          # all questions
  python3 scripts/analyze_comments.py --dataset datasets/d.xlsx
  python3 scripts/analyze_comments.py --question komm_1        # one question only
"""
